...
const MyBookings = () => {
  ...
  useEffect(()=>{
    if(user){
       getMyBookings() // called whenever component get loaded
    }
  }, [user])
    ...
    <div className='relative px-6 md:px-16 lg:px-40 pt-30 md:pt-40 min-h-[80vh]'>
      ...
      {bookings.map((item,index)=>(
        ...
        bg-primary/8 border border-primary/20 rounded-lg mt-4 p-2 max-w-3xl'>
          ...
          {/*left side movie details and right side price and no. of seats*/ }

          <div className='flex flex-col md:flex-row'>
            <img src={TMDB_IMAGE_BASE_URL + item.show.movie.poster_path} alt="" 
