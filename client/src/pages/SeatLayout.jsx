...
const SeatLayout = () => {
  // when we come here in url we have movie id and date of the movie
  ...
  // fxn to get the show data using id
  const getShow = async () => {
    try {
  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      ...
      {/* Seat Layout*/}
      <div className='relative flex-1 flex flex-col items-center max-ms:mt-16'>
